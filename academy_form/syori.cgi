...
# 自スクリプト
my $script = 'https://ssl.flanet.jp/academy_form/syori.cgi';    # 本番用

# 出力CSV
$csv_dir     = '../../csvdata';
$backup_dir  = '../../csvdata/csvbackup';
$csv_data    = 'academy_form.csv';
$backup_data = 'backupacademy_form.csv';
...
# 検証用
# $to1  = 'arakaki@ww-system.com,k.ogawa@gulliver.co.jp,soga@gulliver.co.jp';    # 管理者アドレス
# $from = 'arakaki@ww-system.com';                          # from用管理者アドレス

# メールタイトル
$subject  = '様から食アド(R)Academy申込書のご請求がありました。';                    # 管理者用
$subject2 = '食生活アドバイザー検定　食アド(R)Academy申込書のご請求のご請求完了';    # ユーザ用
...
sub inputdata {
    ...
    $hope_event1  = $formdata{'hope_event1'};
    $hope_event2  = $formdata{'hope_event2'};
    $hope_event3  = $formdata{'hope_event3'};
    $hope_event4  = $formdata{'hope_event4'};
    $hope_event5  = $formdata{'hope_event5'};
    $hope_event6  = $formdata{'hope_event6'};
    $hope_event7  = $formdata{'hope_event7'};
    $hope_event8  = $formdata{'hope_event8'};
    $hope_event9  = $formdata{'hope_event9'};
    $hope_event10 = $formdata{'hope_event10'};
    $hope_event11 = $formdata{'hope_event11'};
    $hope_event12 = $formdata{'hope_event12'};
    $hope_event13 = $formdata{'hope_event13'};
    $hope_event14 = $formdata{'hope_event14'};
    $hope_event15 = $formdata{'hope_event15'};
    $hope_event16 = $formdata{'hope_event16'};
    $hope_event17 = $formdata{'hope_event17'};
    $hope_event18 = $formdata{'hope_event18'};
    $hope_event19 = $formdata{'hope_event19'};
    $hope_event20 = $formdata{'hope_event20'};
    ...
    jcode::convert( \hope_event1,  "sjis", "", "z" );
    jcode::convert( \hope_event2,  "sjis", "", "z" );
    jcode::convert( \hope_event3,  "sjis", "", "z" );
    jcode::convert( \hope_event4,  "sjis", "", "z" );
    jcode::convert( \hope_event5,  "sjis", "", "z" );
    jcode::convert( \hope_event6,  "sjis", "", "z" );
    jcode::convert( \hope_event7,  "sjis", "", "z" );
    jcode::convert( \hope_event8,  "sjis", "", "z" );
    jcode::convert( \hope_event9,  "sjis", "", "z" );
    jcode::convert( \hope_event10, "sjis", "", "z" );
    jcode::convert( \hope_event11, "sjis", "", "z" );
    jcode::convert( \hope_event12, "sjis", "", "z" );
    jcode::convert( \hope_event13, "sjis", "", "z" );
    jcode::convert( \hope_event14, "sjis", "", "z" );
    jcode::convert( \hope_event15, "sjis", "", "z" );
    jcode::convert( \hope_event16, "sjis", "", "z" );
    jcode::convert( \hope_event17, "sjis", "", "z" );
    jcode::convert( \hope_event18, "sjis", "", "z" );
    jcode::convert( \hope_event19, "sjis", "", "z" );
    jcode::convert( \hope_event20, "sjis", "", "z" );
...
sub fileinput {
    ...
    # イベント
    my @event_list;
    map{push(@event_list,${'hope_event'.$_}) if(${'hope_event'.$_} ne '');} (1..20);
...
sub mailmail {
    ...
    $odata2  = "\n・質問1 過去に参加申込をしたことがありますか？：$shitsumon1";
    $odata3  = "\n・質問2 食生活アドバイザー(R)会員ですか？：$shitsumon2";
    $odata4  = "\n・氏名：$name1 $name2";
    $odata5  = "\n・フリガナ：$kana1 $kana2";
    $odata6  = "\n・生年月日：$birth";
    $odata7  = "\n・性別：$sei";
    ...
    $odata16 = "\n・電話番号：$tel1-$tel2-$tel3";
    $odata17 = "\n・E-MAIL：$mail1\@$mail2";
    $odata18 = "\n・参加希望のイベント1：$hope_event1";
    $odata19 = "\n・参加希望のイベント2：$hope_event2";
    $odata20 = "\n・参加希望のイベント3：$hope_event3";
    $odata21 = "\n・参加希望のイベント4：$hope_event4";
    $odata22 = "\n・参加希望のイベント5：$hope_event5";
    $odata23 = "\n・参加希望のイベント6：$hope_event6";
    $odata24 = "\n・参加希望のイベント7：$hope_event7";
    $odata25 = "\n・参加希望のイベント8：$hope_event8";
    $odata26 = "\n・参加希望のイベント9：$hope_event9";
    $odata27 = "\n・参加希望のイベント10：$hope_event10";
    $odata28 = "\n・参加希望のイベント11：$hope_event11";
    $odata29 = "\n・参加希望のイベント12：$hope_event12";
    $odata30 = "\n・参加希望のイベント13：$hope_event13";
    $odata31 = "\n・参加希望のイベント14：$hope_event14";
    $odata32 = "\n・参加希望のイベント15：$hope_event15";
    $odata33 = "\n・参加希望のイベント16：$hope_event16";
    $odata34 = "\n・参加希望のイベント17：$hope_event17";
    $odata35 = "\n・参加希望のイベント18：$hope_event18";
    $odata36 = "\n・参加希望のイベント19：$hope_event19";
    $odata37 = "\n・参加希望のイベント20：$hope_event20";

    # 返信用
    $hdata1 = "$name1$name2様\n\n";

    #    $hdata2 = "参加申込を頂きましてありがとうございます。\n発送まで今しばらくお待ちください。\n登録内容は下記の通りとなります。ご確認お願いします。\n尚、このメールは送信専用アドレスで自動送信しております。\nこのメールに返信されても、返信内容の確認およびご返答ができませんのでご注意ください。\n";
    $hdata2 = "食アド(R)Academy\申\込\書のご請求を頂きましてありがとうございます。\n発送まで今しばらくお待ちください。\n尚、このメールは送信専用アドレスで自動送信しております。\nこのメールに返信されても、返信内容の確認およびご返答ができませんのでご注意ください。";
    $hdata3 = "よろしくお願いいたします。";
    $hdata4 = "\n----------------------------\n";
    ...
    $tdata1 = "WEBからAcademy\申\込\書の請求がありました。";
}
...
sub outputdata {
    ...
    my @hope_event;
    map { push( @hope_event, qq|<tr><td bgcolor="#fde7e3" width="400"><font class="t12"><input type="hidden" name="hope_event$_" value="${'hope_event'.$_}">${ 'hope_event' . $_ }</font></td></tr>| ) if(${ 'hope_event' . $_ } ne ''); } ( 1 .. 20 );
...
<meta name="description" content="食アド&reg;Academy\申\込｜食生活アドバイザー検定">
<meta name="keywords" content="食アド&reg;Academy\申\込｜食生活アドバイザー検定">
<title>食アド&reg;Academy\申\込｜食生活アドバイザー検定</title>
...
<!--------------------メイン開始------------------------>
		...
		<tr><td><font class="t16"><b>食アド&reg;Academy\申\込</b></font><font class="t16" color="red"><b>内容確認ページ</b></font></td></tr>
		<tr><td></td></tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="716">
      <tr>
        <td><font class="t12">■参加希望のイベント</font></td>
      </tr>
    </table>
...
<!--質問-->
		...
		<table border="0" cellpadding="4" cellspacing="2" width="720">
		<tr>
			<td bgcolor="#fdc0b5" width="320"><font class="t12">過去に参加\申\込をしたことがありますか？ (※)</font></td>
			<td bgcolor="#fde7e3" width="400"><font class="t12"><input type="hidden" name="shitsumon1" value="$shitsumon1">$shitsumon1　</font></td>
		</tr>
		<tr>
			<td bgcolor="#fdc0b5" width="320"><font class="t12">食生活アドバイザー&reg;会員ですか？ (※)</font></td>
			<td bgcolor="#fde7e3" width="400"><font class="t12"><input type="hidden" name="shitsumon2" value="$shitsumon2">$shitsumon2　</font></td>
		</tr>
		</table>
		<table border="0" cellpadding="0" cellspacing="0" summary="top">
		<tr>
...
<tr><td align="center"><font class="t12">食アド&reg;Academy</font></td></tr>
</table>
</form>
</div>
</body>
...
<!--------------------メイン開始------------------------>
		<table width="720" border="0" cellpadding="2" cellspacing="0">
		<tr><td><font class="t16"><b>食アド&reg;Academy\申\込書のご請求情報</b></font><font class="t16" color="red"><b>入力完了</b></font></td></tr>
		<tr><td height="30"></td></tr>
		<tr><td><font class="t12">\申\込書のご請求ありがとうございました。<br>
なお、ご登録いただいておりますご住所、お名前などに変更がある方はお早めに検定事務局までフリーダイヤル（0120-20-9039）にてご連絡をお願い致します。<br>
\申\込後、1週間経ってもお手元に届いていない場合は、食アド&reg;Academy事務局までご連絡ください。（ただし、連休をはさむ場合は遅れることがありますのでご了承ください。)<br>
</font></td></tr>
		<tr><td></td></tr>
		</table>
		<table border="0" cellpadding="0" cellspacing="0" summary="top">
...
<tr><td><div class="title">食アド&reg;Academy\申\込<span style="color:#C00;">個人情報の取り扱いについて</span>
</div></td></tr>
...
<tr>
	<td align="center">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style=" padding:0 20px;">
			<tr>
				<td><font class="t12">当協会の『個人情報の取り扱い』にご同意していただけない場合はご請求いただけません。</font></td>
			</tr>
			<tr>
				<td><font class="t12">前ページに戻り、『個人情報の取扱い』に同意の上ご請求ください。</font></td>
			</tr>
			<tr>
				<td><font class="t12">　</font></td>
			</tr>
...
<p style="font-size:12px; text-align:center; padding-top:20px;">食アド&reg;Academy\申\込</p>
</body>
</html>
EOM
        exit(0);
...
<body bgcolor="#ffffff" text="#333333" link="#ffffff" alink="#ffffff" vlink="#ffffff">
<div align="center">
<form action="./gansho.cgi" method="post" name="itiran">
<input type="hidden" name="kensa" value="b">
...
<!--------------------メイン開始------------------------>
		<table width="720" border="0" cellpadding="2" cellspacing="0">
		<tr><td><font class="t16"><b>食アド&reg;Academy\申\込書のご請求</b></font>　<font class="t16" color="red"><b>入力エラー</b></font></td></tr>
		<tr><td></td></tr>
...
EOM
    ...
    if ( $checkhope_event ne "" ) {
        print "<tr><td><font class=t12 color=red>$checkhope_event</font></td></tr>";
    }
...
sub checkdata {
    ...
    $hope_event1  = &no_tag($hope_event1);
    $hope_event2  = &no_tag($hope_event2);
    $hope_event3  = &no_tag($hope_event3);
    $hope_event4  = &no_tag($hope_event4);
    $hope_event5  = &no_tag($hope_event5);
    $hope_event6  = &no_tag($hope_event6);
    $hope_event7  = &no_tag($hope_event7);
    $hope_event8  = &no_tag($hope_event8);
    $hope_event9  = &no_tag($hope_event9);
    $hope_event10 = &no_tag($hope_event10);
    $hope_event11 = &no_tag($hope_event11);
    $hope_event12 = &no_tag($hope_event12);
    $hope_event13 = &no_tag($hope_event13);
    $hope_event14 = &no_tag($hope_event14);
    $hope_event15 = &no_tag($hope_event15);
    $hope_event16 = &no_tag($hope_event16);
    $hope_event17 = &no_tag($hope_event17);
    $hope_event18 = &no_tag($hope_event18);
    $hope_event19 = &no_tag($hope_event19);
    $hope_event20 = &no_tag($hope_event20);
    ...
    if (   $hope_event1 eq ""
        ...
        && $hope_event20 eq "" )
    {
        $checkhope_event = "[参加希望のイベント]が正しく選択されていません。";
        $checkkazu       = "1";
    }
    ...
    if ( $shitsumon2 eq "" ) {
        $checkshitsumon2 = "[食生活アドバイザー&reg;会員ですか？]が正しく選択されていません。";
        $checkkazu       = "1";
    }
