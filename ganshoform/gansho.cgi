...
<!--------------------メイン開始------------------------>
		...
		<tr><td><font class="t12">願書のご請求ありがとうございました。<br>願書は8月上旬から中旬にかけて順次\発\送\予\定\。<br>
なお、ご登録いただいておりますご住所、お名前などに変更がある方はお早めに検定事務局までフリーダイヤルまたは、登録情報変更フォームにてご連絡をお願い致します。<br />
