...
<div class="row">
    <div class="col">
        <form class="application_search" action="{{ route('backend.form_b.applications.index') }}" method="GET">
            <div class="card">
                ...
                <div class="card-footer text-center bg-white">
                    <button type="button" class="search btn btn-primary" data-action="{{ route('backend.form_b.applications.index') }}"><i class="fas fa-search mr-2"></i>検索する</button>
                </div>
            </div>
        </form>
        <div class="card">
            <div class="card-header border-bottom-0">
                ...
                <div class="card-tools">
                    <a href="#" class="csv ml-3" data-action="{{ route('backend.form_b.applications.download_csv') }}"><i class="fas fa-file-csv mr-2"></i>検索結果をCSVダウンロード</a>
                </div>
            </div>
                ...
                <table id="workbook_list" class="table table-striped">
                    ...
                    @foreach ($applications as $application)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('backend.form_b.applications.edit', $application->id) }}" class="ml-3"><i class="fas fa-angle-double-right mr-2"></i>詳細</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
